...
//    lv_obj_set_style_text_font(lv_screen_active(), &lv_font_montserrat_10, LV_PART_MAIN);
 ...
 //   lv_obj_add_event_cb(btn, btn_event_cb, LV_EVENT_ALL, NULL);           /*Assign a callback to the button*/
    ...
    lv_obj_set_pos(btn2, 110, 20);                            /*Set its position*/
    lv_obj_set_size(btn2, 60, 40);                          /*Set its size*/
    lv_obj_set_style_bg_color(btn2, lv_palette_main(LV_PALETTE_PINK), LV_PART_MAIN);

   lv_obj_t * labelb2 = lv_label_create(lv_screen_active());
    lv_label_set_text(labelb2, "0X----");
    lv_obj_set_pos(labelb2, 110, 60);

    lv_obj_t * btn3 = lv_button_create(lv_screen_active());     /*Add a button the current screen*/
    lv_obj_set_pos(btn3, 210, 20);                            /*Set its position*/
    lv_obj_set_size(btn3, 60, 40);                          /*Set its size*/
    lv_obj_set_style_bg_color(btn3, lv_palette_main(LV_PALETTE_PURPLE), LV_PART_MAIN);

    lv_obj_t * btn4 = lv_button_create(lv_screen_active());     /*Add a button the current screen*/
    lv_obj_set_pos(btn4, 310, 20);                            /*Set its position*/
    lv_obj_set_size(btn4, 60, 40);                          /*Set its size*/
    lv_obj_set_style_bg_color(btn4, lv_palette_main(LV_PALETTE_DEEP_PURPLE), LV_PART_MAIN);


    lv_obj_t * btn5 = lv_button_create(lv_screen_active());     /*Add a button the current screen*/
    lv_obj_set_pos(btn5, 410, 20);                            /*Set its position*/
    lv_obj_set_size(btn5, 60, 40);                          /*Set its size*/
    lv_obj_set_style_bg_color(btn5, lv_palette_main(LV_PALETTE_INDIGO), LV_PART_MAIN);

    lv_obj_t * btn6 = lv_button_create(lv_screen_active());     /*Add a button the current screen*/
    lv_obj_set_pos(btn6, 10, 80);                            /*Set its position*/
    lv_obj_set_size(btn6, 60, 40);                          /*Set its size*/
    lv_obj_set_style_bg_color(btn6, lv_palette_main(LV_PALETTE_BLUE), LV_PART_MAIN);

    lv_obj_t * btn7 = lv_button_create(lv_screen_active());     /*Add a button the current screen*/
    lv_obj_set_pos(btn7, 110, 80);                            /*Set its position*/
    lv_obj_set_size(btn7, 60, 40);                          /*Set its size*/
    lv_obj_set_style_bg_color(btn7, lv_palette_main(LV_PALETTE_LIGHT_BLUE), LV_PART_MAIN);
    ...
    lv_obj_t * btn9 = lv_button_create(lv_screen_active());     /*Add a button the current screen*/
    lv_obj_set_pos(btn9, 310, 80);                            /*Set its position*/
    lv_obj_set_size(btn9, 60, 40);                          /*Set its size*/
    lv_obj_set_style_bg_color(btn9, lv_palette_main(LV_PALETTE_AMBER), LV_PART_MAIN);

    lv_obj_t * btn10 = lv_button_create(lv_screen_active());     /*Add a button the current screen*/
    lv_obj_set_pos(btn10, 410, 80);                            /*Set its position*/
    lv_obj_set_size(btn10, 60, 40);                          /*Set its size*/
    lv_obj_set_style_bg_color(btn10, lv_palette_main(LV_PALETTE_GREEN), LV_PART_MAIN);

    lv_obj_t * btn11 = lv_button_create(lv_screen_active());     /*Add a button the current screen*/
    lv_obj_set_pos(btn11, 10, 140);                            /*Set its position*/
    lv_obj_set_size(btn11, 60, 40);                          /*Set its size*/
    lv_obj_set_style_bg_color(btn11, lv_color_hex(0xA5A200), LV_PART_MAIN);

    lv_obj_t * btn12 = lv_button_create(lv_screen_active());     /*Add a button the current screen*/
    lv_obj_set_pos(btn12, 110, 140);                            /*Set its position*/
    lv_obj_set_size(btn12, 60, 40);                          /*Set its size*/
    lv_obj_set_style_bg_color(btn12, lv_color_hex(0x00003f), LV_PART_MAIN);

    lv_obj_t * btn13 = lv_button_create(lv_screen_active());     /*Add a button the current screen*/
    lv_obj_set_pos(btn13, 210, 140);                            /*Set its position*/
    lv_obj_set_size(btn13, 60, 40);                          /*Set its size*/
    lv_obj_set_style_bg_color(btn13, lv_color_hex(0x00005f), LV_PART_MAIN);

    lv_obj_t * btn14 = lv_button_create(lv_screen_active());     /*Add a button the current screen*/
    lv_obj_set_pos(btn14, 310, 140);                            /*Set its position*/
    lv_obj_set_size(btn14, 60, 40);                          /*Set its size*/
    lv_obj_set_style_bg_color(btn14, lv_color_hex(0x00007f), LV_PART_MAIN);

    lv_obj_t * btn15 = lv_button_create(lv_screen_active());     /*Add a button the current screen*/
    lv_obj_set_pos(btn15, 410, 140);                            /*Set its position*/
    lv_obj_set_size(btn15, 60, 40);                          /*Set its size*/
    lv_obj_set_style_bg_color(btn15, lv_color_hex(0x00009f), LV_PART_MAIN);

    lv_obj_t * btn16 = lv_button_create(lv_screen_active());     /*Add a button the current screen*/
    lv_obj_set_pos(btn16, 10, 200);                            /*Set its position*/
    lv_obj_set_size(btn16, 60, 40);                          /*Set its size*/
    lv_obj_set_style_bg_color(btn16, lv_color_hex(0xa54184), LV_PART_MAIN);

    lv_obj_t * btn17 = lv_button_create(lv_screen_active());     /*Add a button the current screen*/
    lv_obj_set_pos(btn17, 110, 200);                            /*Set its position*/
    lv_obj_set_size(btn17, 60, 40);                          /*Set its size*/
    lv_obj_set_style_bg_color(btn17, lv_color_hex(0xa541a5), LV_PART_MAIN);

    lv_obj_t * btn18 = lv_button_create(lv_screen_active());     /*Add a button the current screen*/
    lv_obj_set_pos(btn18, 210, 200);                            /*Set its position*/
    lv_obj_set_size(btn18, 60, 40);                          /*Set its size*/
    lv_obj_set_style_bg_color(btn18, lv_color_hex(0xa56100), LV_PART_MAIN);

    lv_obj_t * btn19 = lv_button_create(lv_screen_active());     /*Add a button the current screen*/
    lv_obj_set_pos(btn19, 310, 200);                            /*Set its position*/
    lv_obj_set_size(btn19, 60, 40);                          /*Set its size*/
    lv_obj_set_style_bg_color(btn19, lv_color_hex(0xa56121), LV_PART_MAIN);

    lv_obj_t * btn20 = lv_button_create(lv_screen_active());     /*Add a button the current screen*/
    lv_obj_set_pos(btn20, 410, 200);                            /*Set its position*/
    lv_obj_set_size(btn20, 60, 40);                          /*Set its size*/
    lv_obj_set_style_bg_color(btn20, lv_color_hex(0xa56142), LV_PART_MAIN);

    lv_obj_t * label10 = lv_label_create(lv_screen_active());
    lv_label_set_text(label10, "ABCDEFGHIJKLMNOPQRSTUVWXYZ");
    lv_obj_set_style_text_color(label10, lv_color_hex(0xa56121), LV_PART_MAIN); 
    lv_obj_set_pos(label10, 20, 300);

    lv_obj_t * label11 = lv_label_create(lv_screen_active());
    lv_label_set_text(label11, "abcdefghijklmnopqrstuvwxyz");
    lv_obj_set_style_text_color(label11, lv_color_hex(0x00a2a5), LV_PART_MAIN); 
    lv_obj_set_pos(label11, 20, 340);

    lv_obj_t * label12 = lv_label_create(lv_screen_active());
    lv_label_set_text(label12, "!%&/()=?[]|{}}/,.-;:€@<>#+*ÜÖÄüöä");
    lv_obj_set_style_text_color(label12, lv_color_hex(0xffffff), LV_PART_MAIN); 
    lv_obj_set_pos(label12, 20, 380);

    lv_obj_t * label13 = lv_label_create(lv_screen_active());
    lv_label_set_text(label13, "##### N K C and L V G L #####");
    lv_obj_set_style_text_font(label13, &my_open_sans_reg_20, 0);
    lv_obj_set_style_text_color(label13, lv_color_hex(0xa56121), LV_PART_MAIN); 
    lv_obj_set_pos(label13, 120, 450);
