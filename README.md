...
Infos
   ...
   - FPGA-GDP video memory hat color format RGB332, LVGL ueterstuetzt dies scheinbar nicht direkt (sagt ChatGPT), Situation ist nicht ganz klar daher ist LVGL bis auf Weiteres als L8 color format (greyscale) konfiguriert, zZT sind die Farben nicht korrekt, und disp_flush ist lahm wg Konvertierung jedes Pixels von L8 in RGB332
