...
Infos
   ...
   - FPGA-GDP video memory hat color format RGB332, LVGL 9.5 ueterstuetzt dies nicht mehr direkt, Situation ist nicht ganz klar daher ist LVGL bis auf Weiteres als L8 color format (greyscale) konfiguriert, zZT sind die Farben nicht korrekt, und disp_flush ist lahm wg Konvertierung jedes Pixels von L8 in RGB332. Eventuell ist es besser auf LVGL 8.3.11 umzusteigen, oder das Format de GDP-FPGA auf ein LVGL unterstütztes umzustellen.
